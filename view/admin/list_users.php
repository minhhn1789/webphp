...
<div class="popup">
    <div class="popuptext" id="popupContent">
        <div id="myPopup"><h1>Error message</h1><a href="list_users.php?clear_mess=true">x</a></div>
        <div>
            <?php
            if($error){
                echo "<p>".$error."</p>";
...
<div class="popup">
    <div class="popuptextSuccess" id="popupContentSuccess">
        <div id="myPopupSuccess"><h1>Message</h1><a href="list_users.php?clear_mess=true">x</a></div>
        <div>
            <?php
            if(isset($_SESSION['admin']['users']['message'])){
                echo "<p>".$_SESSION['admin']['users']['message']."</p>";
            }
            ?>
        </div>
    </div>
                ...
                if(isset($_GET['filter'])){
                    echo '
                        <div class="clear_filter">
                            <a href="list_users.php">Clear Filter</a>
                        </div>
                        ';
                }
                ?>
...
<script>
    const mess =  "<?= isset($_SESSION['admin']['users']['message']) ? 1 : 0 ?>" ;
    if (mess === "1"){
